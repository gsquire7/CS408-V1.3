...
public class FightController {
	...
	public ArrayList<PokemonState> runBattle(ArrayList<PokemonState> currentPokemon, ArrayList<PokemonState> enemyPokemon, ArrayList<MoveEffects> database) throws IOException{	
